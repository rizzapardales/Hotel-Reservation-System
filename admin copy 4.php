    ...
    <script>
        $(document).ready(function() {
            $('.update-button').click(function(e) {
                ...
                const status = $(`select[name='room_status[${reserveId}]']`).val();
    ...
    <form method="POST" action="">
        <table>
            <thead>
                <tr>
                    <!-- Table headers -->
                    <!-- Same headers as your current HTML -->
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td>
                                    <select name='room_status[" . $row["reserve_id"] . "]' class='room-status-dropdown'>
                                ...
                                <td>
                                    <button class='update-button' type='button' value='" . $row["reserve_id"] . "'>Update</button>
                                </td>
                            </tr>";
                    }
                } else {
