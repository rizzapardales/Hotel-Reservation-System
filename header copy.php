...
<body>
    ...
    <div class="second-container">
        <div class="card1">
            ...
            <h2 class="h2-available">5 Rooms Available</h2>
            ...
            <button class="btn" onclick="location.href='../student-form/studentform.html'">Book Now</button>
        </div>
    ...
    <div class="card2">
        ...
        <div class="card2">
            ...
            <button class="btn1" onclick="location.href='../student-form/studentform.html'">Book Now</button>
        </div>
    </div>
