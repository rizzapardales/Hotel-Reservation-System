    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Total Payment</th>
                <th>Room Status</th> <!-- Added column header for Room Status -->
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            $sql = "SELECT 
                        ...
                        cr.reason, rd.total_payment, admin_status.room_status
                    ...
                    LEFT JOIN admin_status ON rd.reserve_id = admin_status.reserve_id
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    echo "<tr>
                            ...
                            <td>
                                <form action='update_status.php' method='post'> <!-- Assuming update_status.php is the script to handle form submission -->
