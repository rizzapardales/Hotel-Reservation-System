<!-- code para madisplay yung num_available na galing sa database -->
<?php
...
<div class="second-container">
    <div class="card1">
        ...
        <button class="btn" type="button" onclick="redirectToReservation('Standard Room');">Book Now</button>
    </div>
    <div class="card1">
        ...
        <button class="btn" type="button" onclick="redirectToReservation('Double Room');">Book Now</button>
    </div> 
</div>
...
<div class="third-container">
    <div class="card2">
        ...
        <button class="btn" type="button" onclick="redirectToReservation('Suite Room');">Book Now</button>
    </div>
    <div class="card2">
        ...
        <button class="btn1" type="button" onclick="redirectToReservation('Deluxe Room');">Book Now</button>
    </div>
</div>
    ...
    <script>
    function redirectToReservation(roomType) {
