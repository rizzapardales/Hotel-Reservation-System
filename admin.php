...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST['update'])) {
            ...
            $sql_update = "UPDATE reservation_details SET room_status='$room_status', room_number='$room_number' WHERE reserve_id='$reserve_id'";
                            ...
                            <form method='post' action=''>
                                ...
                                <td>
                                    <select name='room_number'>
                                        <option value='None'" . ($row["room_number"] == "None" ? " selected" : "") . ">None</option>
                                        <option value='Room 1'" . ($row["room_number"] == "Room 1" ? " selected" : "") . ">Room 1</option>
                                        <option value='Room 2'" . ($row["room_number"] == "Room 2" ? " selected" : "") . ">Room 2</option>
                                        <option value='Room 3'" . ($row["room_number"] == "Room 3" ? " selected" : "") . ">Room 3</option>
                                        <option value='Room 4'" . ($row["room_number"] == "Room 4" ? " selected" : "") . ">Room 4</option>
                                        <option value='Room 5'" . ($row["room_number"] == "Room 5" ? " selected" : "") . ">Room 5</option>
                                    </select>
                                </td>
                                <td>
